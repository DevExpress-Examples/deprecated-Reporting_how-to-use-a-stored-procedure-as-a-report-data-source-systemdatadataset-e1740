...
Namespace RepStoredProc
	...
	Partial Public Class NorthwindDataSet
		...
		Partial Public Class CustOrdersDetailDataTable
			Inherits System.Data.TypedTableBase(Of CustOrdersDetailRow)
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Sub AddCustOrdersDetailRow(ByVal row As CustOrdersDetailRow)
				Me.Rows.Add(row)
			End Sub
			...
			Public Function AddCustOrdersDetailRow(ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Integer, ByVal ExtendedPrice As Decimal) As CustOrdersDetailRow
				...
				Dim columnValuesArray() As Object = { ProductName, UnitPrice, Quantity, Discount, ExtendedPrice}
			...
			Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				...
				If (Me.CustOrdersDetailRowChangedEvent IsNot Nothing) Then
			...
			Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				...
				If (Me.CustOrdersDetailRowChangingEvent IsNot Nothing) Then
			...
			Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				...
				If (Me.CustOrdersDetailRowDeletedEvent IsNot Nothing) Then
			...
			Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				...
				If (Me.CustOrdersDetailRowDeletingEvent IsNot Nothing) Then
		...
		Partial Public Class CustOrdersDetailRow
			...
			Public Property Quantity() As Short
				Get
					Return (CShort(Fix(Me(Me.tableCustOrdersDetail.QuantityColumn))))
				End Get
			...
			Public Property Discount() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableCustOrdersDetail.DiscountColumn))))
					Catch e As Global.System.InvalidCastException
...
Namespace RepStoredProc.NorthwindDataSetTableAdapters
	...
	Partial Public Class CustOrdersDetailTableAdapter
		...
		Public Overridable Function Fill(ByVal dataTable As NorthwindDataSet.CustOrdersDetailDataTable, ByVal OrderID? As Integer) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			If (OrderID.HasValue = True) Then
				Me.Adapter.SelectCommand.Parameters(1).Value = (CInt(Fix(OrderID.Value)))
			Else
		...
		Public Overridable Function GetData(ByVal OrderID? As Integer) As NorthwindDataSet.CustOrdersDetailDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			If (OrderID.HasValue = True) Then
				Me.Adapter.SelectCommand.Parameters(1).Value = (CInt(Fix(OrderID.Value)))
			Else
				Me.Adapter.SelectCommand.Parameters(1).Value = Global.System.DBNull.Value
			End If
			Dim dataTable As New NorthwindDataSet.CustOrdersDetailDataTable()
